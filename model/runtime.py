...
adding a new constraint to fundamental_inputs.CONSTRAINTS, update
...
ASSUMPTIONS_YAML = ASSUMPTIONS_DIR / "phase2_input_assumptions.yaml"
RAW_NOTABLE_AI_MODELS = RAW_DIR / "epoch_notable_ai_models_raw.csv"
PHASE1_TREND_TABLE = TABLES_DIR / "phase1_trend_estimates.csv"

# --- colors --------------------------------------------------------------

# Phase 1 frontier rules (a/b/c).
RULE_COLORS = {
...
# Phase 2 scenarios. Keys must match the `name:` field in scenarios/*.yaml.
SCENARIO_COLORS = {
...
# Phase 2 binding-constraint categories. Keys must match the entries in
# fundamental_inputs.CONSTRAINTS.
CONSTRAINT_COLORS = {
    "chip": "#d62728",
    "power": "#ff7f0e",
    "datacenter": "#9467bd",
